...
<div class="container-login d-flex align-items-center justify-content-center">
    <div class="row d-flex flex-column align-items-center">
            ...
            <div class="d-flex justify-content-center">
                ...
                <img class="rounded" src="<?= base_url() ?>/assets/base/img/logo-login.png?cache<?= date("Y-m-d"); ?>" height="50px">
                </a>
            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="login-form">
                                ...
                                <form method="post" action="<?php echo base_url('do_auth'); ?>" class="user">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-tema-login btn-block">Login</button>
                                    </div>
                                </form>
                                <hr>
                                <div class="text-center">
                                    <a href="<?= $url_site_utama ?>">Beranda</a>
                                </div>
                            </div>
                        </div>
                    </div>
