        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Nomor Whatsapp (untuk konfirmasi pengguna saat Order)</label>
                        <input id="no_hp" type="no_hp" class="form-control" placeholder="Contoh : +6281311112222" value="<?= $admin[0]->no_hp ?>" required>
                    </div>
                    <?php
...
$.ajax({
    ...
    method : "POST",
    data : {username: username,password: password, nama: nama,email:email, no_hp: no_hp},
    async : true,
    dataType : 'html',
