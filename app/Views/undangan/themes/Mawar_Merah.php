...
?>
    ...
    <link href="<?php echo base_url() ?>/assets/themes/Mawar_Merah/css/bootstrap.min.css?" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/Mawar_Merah/css/jquery.fancybox.css?" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Mawar_Merah/mdi/css/materialdesignicons.min.css?">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Mawar_Merah/css/style.css?">
	<?php
...
<div class="thebegining">
	<div class="content-thebegining">
		<div style="position: relative;text-align: center;display:block;margin-top:40px">
			<img src="<?= $kitaPNG ?>" class="cover-foto"/>
			<!-- image border cover -->
            <img src="<?= base_url() ?>/assets/themes/Mawar_Merah/img/bg-flower.png" class="cover-border" /><br>
			<!-- image border cover -->
		</div>
	</div>
	...
	<div class="salam">
		<br/><br/><br/><br/><br/>
		<p style="font-weight: bold;font-size: 30px;color: #fff3f1;">Halo...</p><br>
		
		<?php 
			if(!empty($invite)){
		?>
		<div style=" color: #fff3f1; background-image: url('<?= base_url() ?>/assets/base/img/undangan_sampul/bg-nama-undangan-3-putih.png');font-weight: normal; font-size: 15px;  width: 100%; height: 50px; margin:auto;height: 86px; background-position: center; background-repeat: no-repeat; background-size: unset; text-align: center; padding: 33px;">
			<b>	
				<?php 		
					echo $invite;
				?>
		...
		?>	
		<div style="color: #fff3f1;  background-image: url('');font-weight: normal; font-size: 15px; width: 100%; height: 50px; margin:auto;height: 86px; background-position: center; background-repeat: no-repeat; background-size: unset; text-align: center; padding: 33px;">
			<b>	
				<?php
		...
		<a style="font-weight: bold;font-size: 16px;color: #fff3f1;position: absolute;bottom: 20px;right: 0;left: 0;">klik untuk membuka undangan</a>
</div>		

<div class="dekorasi-all">
	<!-- GAMBAR DEKORASI TENGAH -->
	<!-- <img id="" src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/img/top_flower.png" class="imgatas">  -->

	<!-- GAMBAR DEKORASI KIRI -->
	<img src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/img/kiri-atas.png" class="imgatas-kiri">
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
	    ...
	    <div class="acaranya" >
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
						<!-- <img src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/img/akad-badge.png"> -->
			...
			<table class="tb-acara">
				<thead>
					...
					<!-- <img src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/img/resepsi-badge.png"> -->
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<!-- <img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/img/bottom_flower.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/img/kanan-bawah.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/img/kiri-bawah.png" >  -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Merah/js/script.js"></script>
<script> 
	/*=================
     ADD DOA DAN UCAPAN  
    ======================= */
