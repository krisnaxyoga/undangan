...
?>	
    ...
    <link href="<?php echo base_url() ?>/assets/themes/Mawar_Biru/css/bootstrap.min.css?" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/Mawar_Biru/css/jquery.fancybox.css?" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Mawar_Biru/mdi/css/materialdesignicons.min.css?">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Mawar_Biru/css/style.css?">
...
<div class="thebegining">
	<div class="content-thebegining">
		<div style="text-align: center;display:block;margin-top:40px">
			...
			<!-- image border cover -->
			<img src="<?= base_url() ?>/assets/themes/Mawar_Biru/img/bg-flower.png" class="cover-border" /><br>
			<!-- image border cover --> 
		</div>  
	</div>
...
<div class="dekorasi-all">
	...
	<!-- <img id="" src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/img/top_flower.png" class="imgatas">  -->

	<!-- GAMBAR DEKORASI KIRI -->
	<img src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/img/kiri-atas.png" class="imgatas-kiri">
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
...
<div id="konten" style="z-index: 1;"> 
    ...
    <div id="users_acara-konten" style="display: none;" class="konten">
    	...
    	<div class="section-title">
            <h2> Acara </h2>
			<?php
			//Load Sepatah kata di users_Acara
	    ...
	    <div class="acaranya" >
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
						<!-- <img src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/img/akad-badge.png"> -->
			...
			<table class="tb-acara">
				<thead>
					...
					<!-- <img src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/img/resepsi-badge.png"> -->
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<!-- <img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/img/bottom_flower.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/img/kanan-bawah.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/img/kiri-bawah.png" >  -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Mawar_Biru/js/script.js"></script>
<script> 
	/*=================
     ADD DOA DAN UCAPAN  
    ======================= */
