...
?>	
    ...
    <link href="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/css/bootstrap.min.css?" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/css/jquery.fancybox.css?" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/mdi/css/materialdesignicons.min.css?">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/css/style.css?">
	<?php
...
<div class="thebegining">
	<div class="content-thebegining">
		<div style="text-align: center;display:block;margin-top:70px">			
			<!-- image border cover -->
            <img src="<?= base_url() ?>/assets/themes/Cahaya_Emas/img/bg_flower.png" class="cover-border" /><br>
			<!-- image border cover -->
	...
	<div class="salam"> 
		<p class="salam_p1">Kepada Yth:</p>
		<p class="salam_p2">Bapak/Ibu/Saudara/i</p>
...
<div class="dekorasi-all">
	...
	<img id="" src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/img/top_flower.png" class="imgatas"> 

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/img/bottom_flower.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/img/kiri-bawah.png" >  -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Cahaya_Emas/js/script.js"></script>
<script> 
	/*=================
     ADD DOA DAN UCAPAN  
    ======================= */
