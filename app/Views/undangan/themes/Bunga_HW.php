...
?>	
    ...
    <link href="<?php echo base_url() ?>/assets/themes/Bunga_HW/css/bootstrap.min.css?" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/Bunga_HW/css/jquery.fancybox.css?" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Bunga_HW/mdi/css/materialdesignicons.min.css?">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Bunga_HW/css/style.css?">
	<?php
...
<div class="thebegining">
	<div class="content-thebegining">
		<div style="position: relative;text-align: center;display:block;margin-top:50px">
			<img src="<?= $kitaPNG ?>" class="cover-foto"/>
			<!-- image border cover -->
            <img src="<?= base_url() ?>/assets/themes/Bunga_HW/img/bg_flower.png" class="cover-border" /><br>
			<!-- image border cover -->
		</div>
	</div>
	...
	<div class="salam">
		...
		<p style="font-weight: bold;font-size: 30px;color: #2f3640;">Halo...</p><br>
		
		<?php 
			if(!empty($invite)){
		?>
		<div style=" color: #2f3640; background-image: url('<?= base_url() ?>/assets/base/img/undangan_sampul/bg-nama-undangan-3-hitam.png');font-weight: normal; font-size: 15px;  width: 100%; height: 50px; margin:auto;height: 86px; background-position: center; background-repeat: no-repeat; background-size: unset; text-align: center; padding: 33px;">
			<b>	
				<?php 		
					echo $invite;
				?>
		...
		?>	
		<div style="color: #2f3640;  background-image: url('');font-weight: normal; font-size: 15px; width: 100%; height: 50px; margin:auto;height: 86px; background-position: center; background-repeat: no-repeat; background-size: unset; text-align: center; padding: 33px;">
			<b>	
				<?php
...
<div class="dekorasi-all">
	...
	<img id="" src="<?php echo base_url() ?>/assets/themes/Bunga_HW/img/top_flower.png" class="imgatas"> 

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Bunga_HW/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Bunga_HW/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Bunga_HW/img/bottom_flower.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Bunga_HW/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Bunga_HW/img/kiri-bawah.png" >  -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/Bunga_HW/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Bunga_HW/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/Bunga_HW/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Bunga_HW/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Bunga_HW/js/script.js"></script>
<script> 
	/*=================
     ADD DOA DAN UCAPAN  
    ======================= */
