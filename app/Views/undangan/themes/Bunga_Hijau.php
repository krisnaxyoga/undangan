...
?>	
    ...
    <link href="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/css/bootstrap.min.css?" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/css/jquery.fancybox.css?" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/mdi/css/materialdesignicons.min.css?">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/css/style.css?">
	<?php
...
<div class="thebegining">
	<div class="content-thebegining">
			<div style="text-align: center;display:block;margin-top:70px">
					<!-- image border cover -->
                    <img src="<?= base_url() ?>/assets/themes/Bunga_Hijau/img/bg-flower.png" class="cover-border" /><br>
					<!-- image border cover --> 
	...
	<div class="salam">  
		...
		<a style="font-weight: bold;font-size: 16px;color: #ffffff;position: absolute;bottom: 20px;right: 0;left: 0;">klik untuk membuka undangan</a>
</div>		

<div class="dekorasi-all">
	<!-- GAMBAR DEKORASI TENGAH -->
	<!-- <img id="" src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/img/top_flower.png" class="imgatas">  -->

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<img src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/img/kanan-atas.png" class="imgatas-kanan"> 
</div>
    ...
    <div id="users_acara-konten" style="display: none;" class="konten">
	    ...
	    <div class="acaranya" >
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
						<!-- <img src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/img/akad-badge.png"> -->
						- AKAD NIKAH -
					</th>
				</thead>
				<tbody>
			...
			<table class="tb-acara">
				<thead>
					<th colspan="4" class="acara-title">
					<!-- <img src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/img/resepsi-badge.png"> -->
					- RESEPSI -
					</th>
				</thead>
				<tbody>
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<!-- <img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/img/bottom_flower.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/img/kiri-bawah.png" > 
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Bunga_Hijau/js/script.js"></script>
<script> 
	/*=================
     ADD DOA DAN UCAPAN  
    ======================= */
	...
	$('#submit_doa_dan_ucapan').on('click', function(event) {		
		...
		var recaptcha_status = "<?= $website_umum[19]->website_isi ?>" ;
		$.ajax({
			url : "<?= base_url('add_users_doa_dan_ucapan') ?>",
			method : "POST",
			data : {doa_dan_ucapan_nama_pengunjung: doa_dan_ucapan_nama_pengunjung,doa_dan_ucapan_isi: doa_dan_ucapan_isi,g_recaptcha_response:g_recaptcha_response, recaptcha_status :recaptcha_status},
			async : true,
			dataType : 'html',
