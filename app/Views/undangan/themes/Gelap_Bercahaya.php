...
?>	
    ...
    <link href="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/css/bootstrap.min.css?" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/css/jquery.fancybox.css?" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/mdi/css/materialdesignicons.min.css?">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/css/style.css?">
	<?php
...
<div class="thebegining">
	<div class="content-thebegining">
		<div style="text-align: center;display:block;margin-top:70px">	
			<!-- image border cover -->
            <img src="<?= base_url() ?>/assets/themes/Gelap_Bercahaya/img/bg_flower.png" class="cover-border" /><br>
			<!-- image border cover -->
...
<div class="dekorasi-all">
	...
	<img id="" src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/img/top_flower.png" class="imgatas"> 

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/img/bottom_flower.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/img/kiri-bawah.png" >  -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Gelap_Bercahaya/js/script.js"></script>
<script> 
	/*=================
     ADD DOA DAN UCAPAN  
    ======================= */
