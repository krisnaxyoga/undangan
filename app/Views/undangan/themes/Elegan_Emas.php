...
?>	
    ...
    <link href="<?php echo base_url() ?>/assets/themes/Elegan_Emas/css/bootstrap.min.css?" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/Elegan_Emas/css/jquery.fancybox.css?" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Elegan_Emas/mdi/css/materialdesignicons.min.css?">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Elegan_Emas/css/style.css?">
	<?php
...
<div class="thebegining">
	<div class="content-thebegining">
		<div class="kotak_cover">
			<img src="<?= $kitaPNG ?>" class="thebegining_cover-foto"/>
			<!-- image border cover -->
            <img src="<?= base_url() ?>/assets/themes/Elegan_Emas/img/thebegining_cover_border_bg.png" class="thebegining_cover-border" /><br>
			<!-- image border cover -->
		</div>
	</div>
	...
	<div class="salam"> 
		...
		<span class="salam_mempelai">
			<?php
			$salam_mempelai = $users_mempelai->getResult();
			echo $salam_mempelai[0]->nama_panggilan_pria;
			echo " & ";
			echo $salam_mempelai[0]->nama_panggilan_wanita;
			?>
		...
		<div class="salam_kotak">	
			<!--<img src="<?= base_url() ?>/assets/themes/Elegan_Emas/img/salam_kotak_bg_1024.png" alt="Snow" >-->
		...
		<div class="salam_kotak_nama_undangan_notfound">
			<?php	
				echo "Anda diundang ke pesta pernikahan kami";
			?>
			&#128512;
		</div>
			<?php	
...
<div class="dekorasi-all">
	...
	<img id="" src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/top_flower.png" class="imgatas"> 

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
...
<div id="konten" style="z-index: 1;">
	...
	<div id="sampul-konten" class="konten" >                	
      	<table class="sampul-konten_table"> <!-- tambahkan margin-top:-XX jika kurang ketas -->
      		<tbody>
      		 <tr>
                <th class="sampul-konten_table_th_the-wedding">
                    - THE WEDDING OF -
                </th>
            </tr>
            ...
            <tr>
                <th class="sampul-konten_table_th_foto_sampul" style="background: url('<?= $kitaPNG; ?>') no-repeat;background-size: 100% 100%;">
					<!--
					<img src="<?= $kitaPNG; ?>" class="sampul-konten_cover-foto"/>
					-->
					<!-- image border cover -->
                    <img src="<?= base_url() ?>/assets/themes/Elegan_Emas/img/sampul_cover_border_bg.png" class="sampul-konten_cover-border" /><br>
					<!-- image border cover -->
			...
			<tr>
      			<th class="sampul-konten_table_th_kotak_nama_mempelai">
                    <span class="sampul-konten_table_th_nama-mempelai"><?php echo $row_users_mempelai->nama_panggilan_pria; ?> & <?php echo $row_users_mempelai->nama_panggilan_wanita; ?></span><br>
                    <span class="sampul-konten_table_th_tanggal-weddingnya tanggal-weddingnya"></span>   
                </th>
      		</tr>
      		</tbody>
      	</table>
    ...
    <div id="users_acara-konten" style="display: none;" class="konten">
    	...
    	<div class="section-title">
			...
			foreach ($undangan_sepatah_kata->getResult() as $row_undangan_sepatah_kata_acara1){ 
		...
		<?php
			//Load Sepatah kata di users_Mempelai
			foreach ($undangan_sepatah_kata->getResult() as $row_undangan_sepatah_kata_acara2){ 
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/dekorasi-all_imgbawah.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/kiri-bawah.png" >  -->
</div>

<div class="dekorasi-sampul dekorasi-sampul-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<!-- <img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/bottom_flower.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/img/kiri-bawah.png" > -->
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Elegan_Emas/js/script.js"></script>
<script> 
	/*=================
     ADD DOA DAN UCAPAN  
    ======================= */
