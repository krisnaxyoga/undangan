...
?>	
    ...
    <link href="<?php echo base_url() ?>/assets/themes/Coklat_Manis/css/bootstrap.min.css?" rel="stylesheet">
    <link href="<?php echo base_url() ?>/assets/themes/Coklat_Manis/css/jquery.fancybox.css?" rel="stylesheet">	
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Coklat_Manis/mdi/css/materialdesignicons.min.css?">
	<link rel="stylesheet" href="<?php echo base_url() ?>/assets/themes/Coklat_Manis/css/style.css?">
	<?php
...
<div class="thebegining">
	<div class="content-thebegining">
		<div class="kotak_cover">
			...
			<!-- image border cover -->
            <img src="<?= base_url() ?>/assets/themes/Coklat_Manis/img/bg_flower.png" class="cover-border" /><br>
			<!-- image border cover -->
		</div>
	</div>
	...
	<div class="salam"> 
		...
		<div class="salam_kotak">	
			<img src="<?= base_url() ?>/assets/themes/Coklat_Manis/img/bg_kotak_nama_undangan.png" alt="Snow" >
...
<div class="dekorasi-all">
	...
	<img id="" src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/img/top_flower.png" class="imgatas"> 

	<!-- GAMBAR DEKORASI KIRI -->
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/img/kiri-atas.png" class="imgatas-kiri"> -->
	<!-- GAMBAR DEKORASI KANAN --> 
	<!-- <img src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/img/kanan-atas.png" class="imgatas-kanan">  -->
</div>
...
<div class="dekorasi-all dekorasi-all-bawah">
	<!-- GAMBAR DEKORASI TENGAH --> 
	<img class="imgbawah" src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/img/bottom_flower.png" > 
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kanan" src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/img/kanan-bawah.png" >  -->
	<!-- GAMBAR DEKORASI KIRI --> 
	<!-- <img class="imgbawah-kiri" src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/img/kiri-bawah.png" >  -->
</div>
...
<!-- JS AREA -->
<script src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/js/moment-with-locales.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/js/bootstrap.min.js" ></script>
<script src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/js/jquery.min.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/js/jquery-plugin-collection.js"></script>
<script src="<?php echo base_url() ?>/assets/themes/Coklat_Manis/js/script.js"></script>
<script> 
	/*=================
     ADD DOA DAN UCAPAN  
    ======================= */
	...
	$('#submit_doa_dan_ucapan').on('click', function(event) {		
		...
		$.ajax({
			...
			method : "POST",
			data : {doa_dan_ucapan_nama_pengunjung: doa_dan_ucapan_nama_pengunjung,doa_dan_ucapan_isi: doa_dan_ucapan_isi,kehadiran: kehadiran,jumlah: jumlah,g_recaptcha_response:g_recaptcha_response},
			async : true,
			dataType : 'html',
			success: function($hasil){
				if($hasil == 'sukses'){
					$('.layout-komen').append("<div class='komen' style='display:block'><div class='col-12 doa_dan_ucapan_nama_pengunjung'>"+doa_dan_ucapan_nama_pengunjung+"</div><div class='col-12 doa_dan_ucapan_isi'>"+doa_dan_ucapan_isi+"</div></div>"+"</div><div class='col-12 doa_dan_ucapan_isi'>"+kehadiran,jumlah+" orang</div></div>");
