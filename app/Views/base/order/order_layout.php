        ...
        <div class="col-12 text-lg-left">
            <p class="lead footer-social">
                <?php
                  ...
                  ?>
                  <a href="<?= $row_widget_data_footer_kanan_link->widget_links_url ?>"  class="mx-2 " style="text-decoration: none;" rel="no_follow">
                    <i class="<?= $row_widget_data_footer_kanan_link->widget_links_icon ?>" aria-hidden="true"></i>
                  </a> 
                  <?php
                    }
                  ?>    
...
$(function () {
  ...
  /** croppie shareurcodes.com **/
    ...
    $("#skipGalleryatas").on('change', function() {
      if ($(this).prop('checked')) {
        $("#konten-gallery").hide();
        $(".form-check-input").prop('required',false);
        $("#skipGallery").val("1");
        $('#tombolLanjutORDER5').prop('disabled',false);
      }else{
        $("#konten-gallery").show(); 
        $(".form-check-input").prop('required',true);
        $("#skipGallery").val("0");
        $('#tombolLanjutORDER5').prop('disabled',true);
      }
    });
