...
<div class="container-fluid" id="container-wrapper">
    ...
    <?php 
        ...
        $disabledTombolHapusFotoPria = "";
        $disabledTombolHapusFotoWanita = "";
        $disabledTombolHapusFotoSampul = "";
        if (file_exists($kitaPNG)){
            $fotosampul = '/'.$kitaPNG;
        }else{
            $fotosampul = '/assets/base/img/kita.png';
            $disabledTombolHapusFotoSampul = "disabled";
        }
        if (file_exists($groomPNG)){
            $fotogroom = '/'.$groomPNG;
        }else{
            $fotogroom = '/assets/base/img/groom.png';
            $disabledTombolHapusFotoPria = "disabled";
        }
        if (file_exists($bridePNG)){
            $fotobride = '/'.$bridePNG;
        }else{
            $fotobride = '/assets/base/img/bride.png';
            $disabledTombolHapusFotoWanita = "disabled";
        } 
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <button <?= $disabledTombolHapusFotoPria ?> class="btn btn-danger" data-toggle="modal" data-target="#modalHapusFotoPria"><i class="fas fa-trash"></i> Hapus Foto Pria</button>
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <button <?= $disabledTombolHapusFotoWanita ?> class="btn btn-danger" data-toggle="modal" data-target="#modalHapusFotoWanita"><i class="fas fa-trash"></i> Hapus Foto Wanita</button>
                    <hr>
                    <div class="col mt-2">
                        <label>Nama Lengkap</label>
        ...
        <div class="col-xl-6 col-lg-6 mb-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-12"> 
                            <button <?= $disabledTombolHapusFotoSampul ?> class="btn btn-danger" data-toggle="modal" data-target="#modalHapusFotoSampul"><i class="fas fa-trash"></i> Hapus Foto Sampul</button>
                        </div>
                    </div>  
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Apakah kamu yakin ingin menyimpan perubahan data <b>Mempelai Wanita</b> ?
      </div>
...
<div class="modal fade" id="modalPria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Apakah kamu yakin ingin menyimpan perubahan data <b>Mempelai Pria</b> ?
      </div>
      <div class="modal-footer">
...
<!-- Modal HAPUS FOTO PRIA-->
<div class="modal fade" id="modalHapusFotoPria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Peringatan</h5>
      ...
      <div class="modal-body">
        Apakah kamu yakin ingin hapus <b>Foto Pria</b> ?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-primary" id="hapusFotoPria">Ya</button>
        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Batal</button>
      </div>
    </div>
  </div>
...
<!-- Modal HAPUS FOTO WANITA-->
<div class="modal fade" id="modalHapusFotoWanita" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Peringatan</h5>
      ...
      <div class="modal-body">
        Apakah kamu yakin ingin hapus <b>Foto Wanita</b> ?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-primary" id="hapusFotoWanita">Ya</button>
        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Batal</button>
      </div>
    </div>
  </div>
...
<!-- Modal HAPUS FOTO SAMPUL-->
<div class="modal fade" id="modalHapusFotoSampul" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Peringatan</h5>
      ...
      <div class="modal-body">
        Apakah kamu yakin ingin hapus <b>Foto Sampul</b> ?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-sm btn-primary" id="hapusFotoSampul">Ya</button>
        <button type="button" class="btn btn-sm btn-secondary" data-dismiss="modal">Batal</button>
      </div>
    </div>
  </div>
...
$(document).ready(function () {
        ...
        $("#upload").on("click", function() {
            croppie.result('base64').then(function(base64) {
                ...
                var url = "<?php echo base_url('user/update_foto_users_mempelai') ?>";
    ...
    $('#simpanWanita').on('click', function(event) {
        ...
        console.log(nama);
        $.ajax({
            url : "<?= base_url('user/update_users_mempelai') ?>",
            method : "POST",
    ...
    $('#hapusFotoPria').on('click', function(event) {
    var hapusfotoprianya = 'iya';
        $.ajax({
            url : "<?= base_url('user/hapus_foto_pria') ?>",
            method : "POST",
            data : {hapusfotoprianya: hapusfotoprianya},
            async : true,
            dataType : 'html',
            success: function($hasil){
                if($hasil == 'sukses'){
    ...
    $('#hapusFotoWanita').on('click', function(event) {
    var hapusfotowanitanya = 'iya';
        $.ajax({
            url : "<?= base_url('user/hapus_foto_wanita') ?>",
            method : "POST",
            data : {hapusfotowanitanya: hapusfotowanitanya},
            async : true,
            dataType : 'html',
            success: function($hasil){
                if($hasil == 'sukses'){
    ...
    $('#hapusFotoSampul').on('click', function(event) {
    var hapusfotosampulnya = 'iya';
        $.ajax({
            url : "<?= base_url('user/hapus_foto_sampul') ?>",
            method : "POST",
            data : {hapusfotosampulnya: hapusfotosampulnya},
            async : true,
            dataType : 'html',
            success: function($hasil){
                if($hasil == 'sukses'){
