          ...
          <nav class="navbar navbar-expand-md fixed-top">
            <div class="container">
              <a class="navbar-brand navbar-order" href="<?php echo base_url() ?>">
                <img class="rounded" src="<?php echo base_url() ?>/assets/base/img/logo.png?cache<?= date("Y-m-d"); ?>" height="35" alt="image">
              </a>
            </div>
          </nav>
        </div>
              ...
              <div class="col-12 col-md-8 col-lg-8 col-xl-6">
                ...
                <div class="row">
                  <div class="col text-left">
                    <p tyle="font-size: 15px;font-weight:500; ">1. Buka <a href="https://www.google.com/maps" target="_blank">www.google.com/maps</a> tentukan dan cari lokasi pernikahan kamu</p>
